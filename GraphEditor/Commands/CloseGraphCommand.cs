...
namespace GraphEditor.Commands
{
    class CloseGraphCommand : SyncCommand
    {
        ...
        public override void Execute(object? parameter)
        {
            ...
            {
                MessageBoxResult result = MessageBox.Show("Graph you are trying to close is not saved. Are you sure you want to close it?",
                                                          "Unsaved graph", MessageBoxButton.YesNo);
